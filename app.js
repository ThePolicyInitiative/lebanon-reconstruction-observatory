...
const arabicText = Object.freeze({
  ...
  "The CDR published a request for expressions of interest under LEAP for design, structural assessment, rehabilitation and construction-supervision services for slightly and partially damaged public buildings. An addendum issued on 11 September extended the bid deadline to 22 September. The notice remains a pre-award procurement step: it does not document a selected consultant, contract award, completed supervision or finished works.": "نشر مجلس الإنماء والإعمار طلب إبداء اهتمام ضمن ليب لخدمات التصميم والتقييم الإنشائي والتأهيل والإشراف على التنفيذ للمباني العامة المتضررة بشكل طفيف وجزئي. ومدّد ملحق صادر في 11 أيلول مهلة تقديم العروض إلى 22 أيلول. ويبقى الإعلان خطوة مشتريات قبل الإرساء ولا يثبت اختيار استشاري أو إرساء عقد أو إنجاز الإشراف أو الأعمال.",
  "National framework • Posted 4 Sep 2026 • amended 11 Sep": "إطار وطني • نُشر في 4 أيلول 2026 • عُدّل في 11 أيلول",
  "Addendum issued 11 Sep; bid deadline extended to 22 Sep; no award or completed works reported": "صدر ملحق في 11 أيلول؛ مُدّدت مهلة العروض إلى 22 أيلول؛ لا إبلاغ عن إرساء عقد أو إنجاز أعمال",
  "CDR extends deadline for LEAP public-building services procurement": "مجلس الإنماء والإعمار يمدد مهلة مناقصة خدمات المباني العامة ضمن ليب",
  "Anera launches emergency WASH support for conflict-affected communities": "أنيرا تطلق دعماً طارئاً للمياه والصرف الصحي والنظافة للمجتمعات المتضررة من النزاع",
  "The programme covers hygiene supplies, emergency water and sanitation services, and rehabilitation of critical WASH infrastructure in South Lebanon, Nabatieh, Mount Lebanon and Beirut through February 2027. It is a programme launch, not a completed rehabilitation record.": "يغطي البرنامج مستلزمات النظافة وخدمات المياه والصرف الصحي الطارئة وتأهيل البنية التحتية الحيوية للمياه والصرف الصحي والنظافة في جنوب لبنان والنبطية وجبل لبنان وبيروت حتى شباط 2027. وهو إطلاق برنامج، وليس سجلاً لأعمال تأهيل منجزة.",
  "ICRC reports continued support for essential services and early recovery": "اللجنة الدولية للصليب الأحمر تُبلغ عن استمرار دعم الخدمات الأساسية والتعافي المبكر",
  "ICRC reports an April–September response that includes health, water, habitat and livelihoods support, including a remote monitoring and operation centre for South Lebanon pumping stations. This is organisational reporting, not independent verification of recovery outcomes.": "تُبلغ اللجنة الدولية للصليب الأحمر عن استجابة من نيسان إلى أيلول تشمل دعم الصحة والمياه والمأوى وسبل العيش، بما في ذلك مركز مراقبة وتشغيل عن بُعد لمحطات الضخ في جنوب لبنان. هذا إبلاغ من الجهة المنفذة، وليس تحققاً مستقلاً من نتائج التعافي.",
  "118 Lebanese environmental NGOs endorse the Hima for Peace initiative": "118 منظمة بيئية لبنانية تؤيد مبادرة الحِمى من أجل السلام",
  "The civil-society coalition endorsed a voluntary framework for community-led conservation, sustainable livelihoods, climate resilience and peacebuilding. It is a shared commitment rather than a financing agreement or completed intervention.": "أيد ائتلاف المجتمع المدني إطاراً طوعياً للحفاظ المجتمعي وسبل العيش المستدامة والقدرة على التكيف مع المناخ وبناء السلام. وهو التزام مشترك لا اتفاق تمويل ولا تدخلاً منجزاً.",
  "Tripoli community co-funding system opens a route to support local priorities": "نظام التمويل المشترك المجتمعي في طرابلس يفتح مساراً لدعم الأولويات المحلية",
  "The initiative presents a community-led contribution system for projects identified by Tripoli communities. It is a fundraising and participation mechanism, not evidence that the listed priorities have been fully funded or delivered.": "تعرض المبادرة نظام مساهمة تقوده المجتمعات المحلية لمشاريع تحددها مجتمعات طرابلس. وهي آلية للتمويل والمشاركة، وليست دليلاً على تمويل الأولويات المدرجة أو تنفيذها بالكامل.",
  "Fair Trade Lebanon launches cash-for-work programme with local municipalities": "فير تريد لبنان تطلق برنامج عمل مقابل أجر مع البلديات المحلية",
  "The seven-month programme plans 633 cash-for-work participants in Baabda and Baalbek for shared-space cleaning, waste management, irrigation-canal rehabilitation and maintenance of shelters and community assets. It is a programme launch, not a completed-work record.": "يخطط البرنامج الممتد لسبعة أشهر لمشاركة 633 شخصاً في العمل مقابل أجر في بعبدا وبعلبك لتنظيف المساحات المشتركة وإدارة النفايات وتأهيل قنوات الري وصيانة الملاجئ والأصول المجتمعية. وهو إطلاق برنامج، وليس سجلاً لأعمال مكتملة.",
  "Tripoli youth and municipality report safer-streets mobility support": "شباب طرابلس والبلدية يبلّغون عن دعم للتنقل من أجل شوارع أكثر أماناً",
  "VNG International reports that electric scooters and bicycles were handed over to municipal police through a youth-informed community-led safety and mobility initiative. The report confirms the equipment handover, not a citywide safety outcome.": "تفيد منظمة في إن جي إنترناشيونال بأنه تم تسليم دراجات كهربائية وسكوترات للشرطة البلدية عبر مبادرة للسلامة والتنقل قادها المجتمع وأُعدت بمساهمة الشباب. يؤكد التقرير تسليم المعدات، لا تحقيق نتيجة سلامة على مستوى المدينة.",
  "IOM sets out community-based stabilization and local-service plans": "المنظمة الدولية للهجرة تطرح خططاً للاستقرار المجتمعي والخدمات المحلية",
  "IOM's 2026 response plan seeks funding for community-based planning, local committees and projects for public infrastructure, facilities and essential services. It is a funding requirement and planned response, not proof of funding received or completed delivery.": "تطلب خطة استجابة المنظمة الدولية للهجرة لعام 2026 تمويلاً للتخطيط القائم على المجتمع واللجان المحلية ومشاريع البنية التحتية والمرافق والخدمات الأساسية. وهي احتياج تمويلي واستجابة مخططة، وليست دليلاً على تلقي التمويل أو إنجاز التنفيذ.",
  "UNIFIL reports municipal and community support across South Lebanon": "اليونيفيل تُبلغ عن دعم بلدي ومجتمعي في أنحاء جنوب لبنان",
  "UNIFIL reports medical, education, veterinary and humanitarian-mission support identified with municipalities and community representatives, including repair of two municipal firefighting trucks in El Hebbariye. This is UNIFIL operational reporting, not independent verification of outcomes.": "تُبلغ اليونيفيل عن دعم طبي وتعليمي وبيطري وتسهيل مهام إنسانية تم تحديدها مع البلديات وممثلي المجتمع، بما في ذلك إصلاح شاحنتي إطفاء بلديتين في الهبارية. هذا إبلاغ تشغيلي من اليونيفيل، وليس تحققاً مستقلاً من النتائج.",
  "Baalbek municipality and Himaya Association launch a council for children": "بلدية بعلبك وجمعية حماية تطلقان مجلساً للأطفال",
  "A local media report says members were selected with schools and associations to represent neighbourhoods, girls and children with special needs, and received preparatory training. It records a launch, not independent evidence of ongoing activity or city projects.": "يفيد تقرير إعلامي محلي بأن الأعضاء اختيروا بالتنسيق مع المدارس والجمعيات لتمثيل الأحياء والفتيات والأطفال ذوي الاحتياجات الخاصة، وتلقوا تدريباً تحضيرياً. وهو يسجل إطلاقاً، وليس دليلاً مستقلاً على نشاط مستمر أو مشاريع للمدينة.",
  "TREF board reaffirms direction for education recovery and reform": "مجلس صندوق التحول والمرونة يؤكد التوجه نحو التعافي التعليمي والإصلاح",
  "MEHE convened the third TREF Strategic Management Board with Government, contributing partners and UNICEF to guide education recovery for the 2026/2027 school year. It reaffirmed priorities for safe learning, learning recovery and reform, without announcing a new financing decision or completed output.": "عقدت وزارة التربية والتعليم العالي الاجتماع الثالث للمجلس الاستراتيجي لصندوق التحول والمرونة بمشاركة الحكومة والشركاء المساهمين واليونيسف لتوجيه التعافي التعليمي للعام الدراسي 2026/2027. وأكد الاجتماع أولويات التعلم الآمن وتعافي التعلم والإصلاح، من دون إعلان قرار تمويل جديد أو مخرج مكتمل.",
  "UNIFIL reports community-livelihood and humanitarian-access support in South Lebanon": "اليونيفيل تُبلغ عن دعم سبل العيش المجتمعية والوصول الإنساني في جنوب لبنان",
  "UNIFIL reports work with municipalities and community groups on fairs, market access, vocational training, children’s activities and humanitarian facilitation. The report includes a Tyre exhibition with more than 100 women entrepreneurs, but is not independent verification of local livelihood outcomes.": "تُبلغ اليونيفيل عن العمل مع البلديات والمجموعات المجتمعية في المعارض والوصول إلى الأسواق والتدريب المهني وأنشطة الأطفال وتسهيل العمل الإنساني. ويشمل التقرير معرضاً في صور ضم أكثر من 100 سيدة رائدة أعمال، لكنه ليس تحققاً مستقلاً من نتائج سبل العيش المحلية.",
  "UNDP and Lebanese Red Cross sign disaster-resilience cooperation agreement": "برنامج الأمم المتحدة الإنمائي والصليب الأحمر اللبناني يوقعان اتفاق تعاون للصمود أمام الكوارث",
  "The memorandum of understanding sets a framework for community emergency preparedness, early action and risk-informed response. It is a cooperation agreement, not a completed delivery or resilience outcome.": "تحدد مذكرة التفاهم إطاراً للجهوزية المجتمعية للطوارئ والعمل المبكر والاستجابة المبنية على المخاطر. وهي اتفاق تعاون، وليست دليلاً على تنفيذ مكتمل أو نتيجة صمود متحققة.",
  "NEWLY REVIEWED · 16 SEP 2026": "مراجعة حديثة · 16 أيلول 2026",
  "LEAP public-building bid deadline extended to 22 September": "تمديد مهلة العروض لخدمات المباني العامة ضمن ليب إلى 22 أيلول",
  "An 11 September CDR addendum extended the deadline for framework services covering slightly and partially damaged public buildings. The notice remains pre-award: it does not name a consultant, report a contract award or establish completed works.": "مدّد ملحق صادر عن مجلس الإنماء والإعمار في 11 أيلول مهلة العروض لخدمات الاتفاق الإطاري للمباني العامة المتضررة بشكل طفيف وجزئي. ويبقى الإعلان قبل الإرساء: لا يسمي استشارياً ولا يبلّغ عن إرساء عقد أو يثبت أعمالاً منجزة.",
  "Open the CDR notice": "افتح إعلان مجلس الإنماء والإعمار",
  "An 11 September addendum extended the bid deadline for the framework services procurement covering slightly and partially damaged public buildings to 22 September. It remains a pre-award notice, not a consultant selection, contract award or completed works record.": "مدّد ملحق صادر في 11 أيلول مهلة تقديم العروض لخدمات الاتفاق الإطاري للمباني العامة المتضررة بشكل طفيف وجزئي إلى 22 أيلول. ويبقى إعلاناً قبل الإرساء، وليس سجلاً لاختيار استشاري أو إرساء عقد أو إنجاز أعمال.",
  "Design, structural assessment, rehabilitation and construction-supervision services for slightly and partially damaged public buildings; bid deadline extended to 22 Sep 2026": "خدمات التصميم والتقييم الإنشائي والتأهيل والإشراف على التنفيذ للمباني العامة المتضررة بشكل طفيف وجزئي؛ مُدّدت مهلة العروض إلى 22 أيلول 2026",
  "Rafik Hariri University Hospital MRI Procurement 2026": "مشتريات جهاز تصوير بالرنين المغناطيسي لمستشفى رفيق الحريري الجامعي 2026",
  "Hospital equipment procurement": "مشتريات معدات المستشفيات",
  "Named as the recipient site in a CDR notice for MRI supply and installation under LEAP. The notice is a pre-award tender and does not identify a supplier, delivery or installed equipment.": "ورد اسم المستشفى كموقع مستفيد في إعلان لمجلس الإنماء والإعمار لتوريد وتركيب جهاز تصوير بالرنين المغناطيسي ضمن ليب. الإعلان مناقصة قبل الإرساء ولا يحدد مورّداً أو تسليماً أو جهازاً مركباً.",
  "CDR LEAP MRI procurement notice": "إعلان مجلس الإنماء والإعمار لمناقصة جهاز الرنين المغناطيسي ضمن ليب",
  "Open LEAP procurement for MRI supply and installation at Rafik Hariri University Hospital": "إطلاق مناقصة ليب لتوريد وتركيب جهاز تصوير بالرنين المغناطيسي في مستشفى رفيق الحريري الجامعي",
  "The CDR published an open international tender under LEAP to supply and install an MRI machine for the Ministry of Public Health's Rafik Hariri University Hospital. It is a pre-award procurement step and does not document a selected supplier, contract award, equipment delivery or installation.": "نشر مجلس الإنماء والإعمار مناقصة دولية مفتوحة ضمن ليب لتوريد وتركيب جهاز تصوير بالرنين المغناطيسي لمستشفى رفيق الحريري الجامعي التابع لوزارة الصحة العامة. وهي خطوة مشتريات قبل الإرساء ولا تثبت اختيار مورّد أو إرساء عقد أو تسليم معدات أو تركيبها.",
  "Council for Development and Reconstruction / Ministry of Public Health / World Bank / LEAP Project Management Unit": "مجلس الإنماء والإعمار / وزارة الصحة العامة / البنك الدولي / وحدة إدارة مشروع ليب",
  "LEAP MRI Supply and Installation Procurement": "مناقصة ليب لتوريد وتركيب جهاز تصوير بالرنين المغناطيسي",
  "Rafik Hariri University Hospital, Beirut • Posted 9 Sep 2026": "مستشفى رفيق الحريري الجامعي، بيروت • نُشرت في 9 أيلول 2026",
  "Council for Development and Reconstruction / Ministry of Public Health / World Bank": "مجلس الإنماء والإعمار / وزارة الصحة العامة / البنك الدولي",
  "Open tender only; no supplier, delivery or installation reported": "مناقصة مفتوحة فقط؛ لا إبلاغ عن مورّد أو تسليم أو تركيب",
  "CDR opens LEAP MRI procurement for Rafik Hariri University Hospital": "مجلس الإنماء والإعمار يطلق مناقصة ليب لجهاز الرنين المغناطيسي في مستشفى رفيق الحريري الجامعي",
  "The CDR notice requests bids to supply and install an MRI machine for the Ministry of Public Health's Rafik Hariri University Hospital. It is an open pre-award procurement, not a supplier selection, equipment delivery or installation record.": "يطلب إعلان مجلس الإنماء والإعمار عروضاً لتوريد وتركيب جهاز تصوير بالرنين المغناطيسي لمستشفى رفيق الحريري الجامعي التابع لوزارة الصحة العامة. وهو إجراء مشتريات مفتوح قبل الإرساء، وليس سجلاً لاختيار مورّد أو تسليم معدات أو تركيبها.",
  "LEAP MRI supply and installation procurement": "مناقصة ليب لتوريد وتركيب جهاز تصوير بالرنين المغناطيسي",
  "Open tender to supply and install an MRI machine for Rafik Hariri University Hospital under LEAP": "مناقصة مفتوحة لتوريد وتركيب جهاز تصوير بالرنين المغناطيسي لمستشفى رفيق الحريري الجامعي ضمن ليب",
  "South Lebanon Municipal and Union Waste-Service Partners": "شركاء البلديات واتحادات البلديات لخدمات النفايات في جنوب لبنان",
  "Municipal waste-service delivery": "تقديم خدمات النفايات البلدية",
  "Received EU-funded collection trucks through UNDP and the Ministry of Environment to help sustain collection services in 15 municipalities and Unions of Municipalities in South Lebanon.": "تلقّوا شاحنات جمع نفايات بتمويل من الاتحاد الأوروبي عبر برنامج الأمم المتحدة الإنمائي ووزارة البيئة للمساعدة في استدامة خدمات الجمع في 15 بلدية واتحاد بلديات في جنوب لبنان.",
  "UNDP municipal waste-service delivery update": "تحديث برنامج الأمم المتحدة الإنمائي عن تقديم خدمات النفايات البلدية",
  "Bekaa Waste-Management Facilities": "مرافق إدارة النفايات في البقاع",
  "Facilities serving Zahle, Baalbek and Joub Jannine received EU-funded machinery through UNDP and the Ministry of Environment to strengthen local waste-service operations.": "تلقت المرافق التي تخدم زحلة وبعلبك وجب جنين معدات بتمويل من الاتحاد الأوروبي عبر برنامج الأمم المتحدة الإنمائي ووزارة البيئة لتعزيز عمليات خدمات النفايات المحلية.",
  "Deliver municipal waste-service equipment in Bekaa and South Lebanon": "تسليم معدات لخدمات النفايات البلدية في البقاع وجنوب لبنان",
  "Municipal service delivery": "تقديم الخدمات البلدية",
  "EU-funded UNDP deliveries, in partnership with the Ministry of Environment, included nine machinery units for three waste-management facilities in the Bekaa and 17 collection trucks for 15 municipal and union partners in South Lebanon. The source confirms delivered equipment, not a wider reconstruction financing commitment or completed municipal works programme.": "شملت عمليات التسليم التي نفذها برنامج الأمم المتحدة الإنمائي بتمويل من الاتحاد الأوروبي وبالشراكة مع وزارة البيئة تسع وحدات آلية لثلاثة مرافق لإدارة النفايات في البقاع و17 شاحنة جمع لـ15 شريكاً من البلديات والاتحادات في جنوب لبنان. يؤكد المصدر تسليم المعدات، وليس التزاماً أوسع لتمويل إعادة الإعمار أو برنامجاً منجزاً للأعمال البلدية.",
  "European Union / UNDP / Ministry of Environment / municipal and union partners": "الاتحاد الأوروبي / برنامج الأمم المتحدة الإنمائي / وزارة البيئة / شركاء البلديات والاتحادات",
  "EU and UNDP Municipal Waste-Service Equipment Delivery": "تسليم الاتحاد الأوروبي وبرنامج الأمم المتحدة الإنمائي معدات لخدمات النفايات البلدية",
  "Bekaa and South Lebanon • Delivered 9 Sep 2026": "البقاع وجنوب لبنان • سُلّمت في 9 أيلول 2026",
  "EU-funded equipment delivery": "تسليم معدات بتمويل من الاتحاد الأوروبي",
  "Delivered machinery and collection trucks to help sustain municipal waste services": "معدات وشاحنات جمع مُسلّمة للمساعدة في استدامة خدمات النفايات البلدية",
  "EU and UNDP deliver municipal waste-service equipment in Bekaa and South Lebanon": "الاتحاد الأوروبي وبرنامج الأمم المتحدة الإنمائي يسلّمان معدات لخدمات النفايات البلدية في البقاع وجنوب لبنان",
  "EU-funded deliveries provided machinery to three Bekaa waste-management facilities and collection trucks to 15 municipal and union partners in South Lebanon. This is a reported equipment delivery, not a new reconstruction financing commitment or a completed works programme.": "وفرت عمليات التسليم بتمويل من الاتحاد الأوروبي معدات لثلاثة مرافق لإدارة النفايات في البقاع وشاحنات جمع لـ15 شريكاً من البلديات والاتحادات في جنوب لبنان. هذا تسليم معدات مُبلّغ عنه، وليس التزاماً جديداً لتمويل إعادة الإعمار أو برنامجاً منجزاً للأعمال.",
  "Municipal waste-service equipment delivery": "تسليم معدات لخدمات النفايات البلدية",
  "Official municipal service-delivery update": "تحديث رسمي عن تقديم خدمات بلدية",
  "Nine machinery units for three Bekaa waste-management facilities and 17 collection trucks for 15 municipal and union partners in South Lebanon": "تسع وحدات آلية لثلاثة مرافق لإدارة النفايات في البقاع و17 شاحنة جمع لـ15 شريكاً من البلديات والاتحادات في جنوب لبنان",
  ...
  "Community initiative": "مبادرة مجتمعية",
