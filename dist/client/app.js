...
const arabicText = Object.freeze({
  ...
  "UNIFIL reports medical care, medicines and supplies for local health facilities, veterinary and education support, and humanitarian-mission facilitation identified with municipalities and community representatives. This is UNIFIL operational reporting, not independent verification of outcomes.": "تُبلغ اليونيفيل عن رعاية طبية وأدوية ومستلزمات لمرافق صحية محلية ودعم بيطري وتعليمي وتسهيل مهام إنسانية تم تحديدها مع البلديات وممثلي المجتمع. هذا إبلاغ تشغيلي من اليونيفيل، وليس تحققاً مستقلاً من النتائج.",
